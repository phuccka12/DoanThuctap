...
import { FaPenFancy, FaMicrophoneAlt, FaHeadphones, FaLayerGroup } from "react-icons/fa";

/**
 * OnboardingStep3 - Màn 3: Kỹ năng cần cải thiện
...
const OPTIONS = [
  {
    ...
    subtitle: "AI sẽ ưu tiên các bài tập cấu trúc câu và tư duy lập luận sắc bén",
    color: "from-[#6C5CE7] to-[#A29BFE]",
  },
  {
    id: "speaking",
    icon: <FaMicrophoneAlt />,
    title: "Kỹ năng Nói (Speaking Fluency)",
    subtitle: "Tập trung tối đa vào phát âm chuẩn và phản xạ giao tiếp tự nhiên",
    color: "from-[#00CEC9] to-[#0984E3]",
  },
  {
    id: "listening",
    icon: <FaHeadphones />,
    title: "Kỹ năng Nghe (Deep Listening)",
    subtitle: "Tăng cường khả năng nhận diện âm thanh và lọc thông tin cốt lõi",
    color: "from-[#FDCB6E] to-[#E17055]",
  },
  {
    id: "all",
    icon: <FaLayerGroup />,
    title: "Phát triển Toàn diện (All-in-One)",
    subtitle: "Lộ trình cân bằng hoàn hảo giữa tất cả các kỹ năng ngôn ngữ",
    color: "from-[#FD79A8] to-[#E84393]",
  },
];

export default function OnboardingStep3({ onNext, onBack }) {
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-r from-[#00CEC9] to-[#0984E3] shadow-lg mb-6">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Chọn kỹ năng bạn muốn tập trung để chúng tôi tạo bài tập phù hợp
          </p>
        </div>
