...
const OPTIONS = [
  {
    ...
    icon: <FaPenFancy />,
    title: "Writing (Viết)",
    subtitle: "Cần cải thiện cấu trúc bài viết, từ vựng học thuật và ngữ pháp",
  ...
  },
  {
    ...
    title: "Speaking (Nói)",
    subtitle: "Cần luyện phát âm, tăng độ tự tin và phản xạ trong giao tiếp",
  ...
  },
  {
    ...
    subtitle: "Cần cải thiện khả năng bắt từ, nghe hiểu và ghi chép nhanh",
  ...
  },
  {
    ...
    subtitle: "Cần lộ trình toàn diện để cải thiện đồng đều cả 4 kỹ năng",
