...
const ECONOMY_KEYS = [
  ...
  { key: 'economy_hunger_dying_threshold', label: 'Ngưỡng Đói – Hấp hối (>= X)',        group: 'economy', field_type: 'number', sort_order: 12, description: 'Khi hunger >= X → Pet hấp hối → khóa EXP user', value: '100' },
  { key: 'economy_exp_buff_happy_pct',     label: '% EXP buff khi Pet vui vẻ',          group: 'economy', field_type: 'number', sort_order: 13, description: 'User được cộng thêm X% EXP khi Pet đang vui vẻ (VD: 10 = +10%)', value: '10' },
  { key: 'economy_freeze_streak_cost',     label: 'Giá Bùa Đóng Băng Streak (Coins)',   group: 'economy', field_type: 'number', sort_order: 14, description: 'Bao nhiêu Coins để mua 1 Bùa Đóng Băng bảo vệ chuỗi streak', value: '500' },
  { key: 'economy_pet_exp_per_level_base', label: 'EXP Base để Pet lên cấp',            group: 'economy', field_type: 'number', sort_order: 15, description: 'Công thức: cần (base × level) EXP để tăng 1 level (nếu không dùng Pokedex milestones)', value: '100' },
];
